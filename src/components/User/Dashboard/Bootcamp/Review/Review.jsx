...
export default function Review({ reviews, course, stats, slug }) {
  return (
    reviews.length > 0 && (
      <div className="course-review">
        ...
        <div className={styles.rate}>
          <div className={styles.rate_left}>
            <h1>
              {/* {(course.rating_sum / course.rated_user).toFixed(1)} */}
              {slug === "reactjs-babd7" ? 4.5 : 4.2}
            </h1>
            <div>
              {" "}
              <Rating
                // value={course.rating_sum / course.rated_user}
                value={slug === "reactjs-babd7" ? 4.5 : 4.2}
                readOnly
                precision={0.5}
