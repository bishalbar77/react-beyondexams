...
function LiveClasses({
  ...
  useEffect(() => {
    let date1 = new Date(live_class.created_at);
  ...
  return (
    <>
      <div
        className="videoCard"
        onDragStart={(e) => ondragstart(live_class.url, module.id)}
        draggable={
