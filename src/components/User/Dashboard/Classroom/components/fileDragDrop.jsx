...
class DragAndDrop extends Component {
  ...
  handleFileCheck = (files, type) => {
    ...
    formData.append("chat_id", localStorage.getItem("chat_id"));
    ...
    return (
      <>
        <div
          ...
          onDragEnter={(e) =>
            !this.state.showSuccess && this.handleDragEnter(e)
          }
          onDragLeave={(e) =>
            !this.state.showSuccess && this.handleDragLeave(e)
          }
        >
