...
import ListUnit from "./ListChatChannels";
...
function ChatChannels({ type }) {
  const [userData, setUserData] = useState([]);
  const [isLast, setIsLast] = useState(false);
  const [nextPage, setNextPage] = useState(null);
  const [keywords, setKeywords] = useState([]);
  const [input, setInput] = useState("");
  const [url, setURL] = useState("get_chat_rooms?sortBy=0");
  ...
  const handleSorting1 = () => {
    var newURL = "get_chat_rooms?sortBy=1";
    setURL(newURL)
    setUserData([]);
  ...
  const handleSorting = () => {
    var newURL = "get_chat_rooms?sortBy=0";
    setURL(newURL)
    setUserData([]);
    fetchCourseDataAgain(newURL);
  };
        ...
        <main className="Leaderboard-main">
          <div className="l-wrapper">
            ...
            <button className="c-button c-button--primary">Educator LeaderBoard</button> */}
              <h1 className="c-title">{"Beyondexams Chat Rooms"}</h1>
            </div>
                    ...
                    <ul className="c-list" id="list">
                      <li className="c-list__item">
                        <div className="c-list__grid">
                          ...
                          <div className="u-text--left u-text--small u-text--medium">Chat Room Details</div>
                          <div className="u-text--left u-text--small u-text--medium">Creator</div>
